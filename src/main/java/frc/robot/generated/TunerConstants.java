...
public class TunerConstants 
{
    ...
    public static Matrix<N3, N1> odometryStandardDeviation = VecBuilder.fill(0.3,0.3,.2);   // TODO - tune
    public static Matrix<N3, N1> visionStandardDeviation  = VecBuilder.fill(.1,0.1,9999999);    // TODO - tune
    public static PathConstraints oTF_Constraints = new PathConstraints(5.3, 5, Math.toRadians(270), Math.toRadians(360));  // TODO - tune
    // Both sets of gains need to be tuned to your individual robot.

    // The steer motor uses any SwerveModule.SteerRequestType control request with the
    // output type specified by SwerveModuleConstants.SteerMotorClosedLoopOutput
    private static final Slot0Configs steerGains = new Slot0Configs()   // TODO - Tune
        .withKP(50).withKI(0).withKD(0)        // P was 100,
        .withKS(0).withKV(0).withKA(0)     // 0.1 |    2.66    0
        .withStaticFeedforwardSign(StaticFeedforwardSignValue.UseClosedLoopSign);
    // When using closed-loop control, the drive motor uses the control
    // output type specified by SwerveModuleConstants.DriveMotorClosedLoopOutput
    private static final Slot0Configs driveGains = new Slot0Configs()   // TODO - Tune
    ...
    private static final Angle kFrontLeftEncoderOffset = Rotations.of(-0.3193359375);
    ...
    private static final Angle kFrontRightEncoderOffset = Rotations.of(0.12060546875);
    ...
    private static final Angle kBackRightEncoderOffset = Rotations.of(0.4052734375);
